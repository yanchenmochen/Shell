...
if __name__ == "__main__":
    file_path = "/mnt/nas-v1/self-define/dongjie/model/dataset/tulu3/data/tulu-3-sft-mixture/tulu_v3_mix.jsonl"  # 替换为你的JSONL文件路径
    #file_path = "/mnt/self-define/songquanheng/dataset/tulu3/data/tulu-3-sft-mixture/tulu_v3_mix_v3.json"
    #file_path = "/mnt/nas-v1/self-define/songquanheng/toolkits/new_standard_tulu3.json"
