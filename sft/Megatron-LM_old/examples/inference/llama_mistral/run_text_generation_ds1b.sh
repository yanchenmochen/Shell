...
export MUSA_BLOCK_SCHEDULE_MODE=0
export MCCL_IB_GID_INDEX=3
export MCCL_NET_SHARED_BUFFERS=0
export MCCL_IB_TC=122
export MCCL_IB_QPS_PER_CONNECTION=16
export PYTHONPATH=/mnt/seed-program-nas/001688/chenyiming/megatron-lm-musa-patch:/mnt/seed17/001688/haoran.huang/Megatron-LM_sft:$PYTHONPATH
...
CHECKPOINT=/mnt/seed-program-nas/001688/xiechunhong/1B_Loss_Align/output/1st_attempt/checkpoints/
# CHECKPOINT=/mnt/si0003568lza/default/huanghuang/ckpt_bkup_001688/1B_Loss_Align_New_Megatron/output/std-norm-fp32-gbs4k/checkpoints/
CHECKPOINT=/mnt/seed17/001688/haoran.huang/megatron-lm-musa-patch/examples/deepseek-sft/checkpoints/tp1_pp1_dp8_mbs1_numbs128_gbs1024_gpus8
...
torchrun $DISTRIBUTED_ARGS tools/run_text_generation_server_mmlu.py   \
      --ckpt-format torch \
      --use-mcore-models \
      --disable-bias-linear \
    ...
    --seq-length 4096
#    --use-flash-attn \ --moe-permute-fusion \