...
export PYTHONPATH=/mnt/seed-program-nas/001688/songquanheng/Shell/sft/megatron-lm-musa-patch:$PYTHONPATH
...
cd /mnt/seed-program-nas/001688/songquanheng/Shell/sft/Megatron-LM_old
