...
TOKENIZER_MODEL='/mnt/hw-nas/public/models/zjllm-llama3-tokenizer'
CHECKPOINT='/mnt/hw-nas/002147/yanjun/data/pretrain/new-source-iter50000'
...
cd /mnt/seed-program-nas/001688/haoran.huang/Megatron-LM_old/
cmd="torchrun ${DISTRIBUTED_ARGS[@]} tools/run_text_generation_server.py  \
    --ckpt-format torch \
    --use-mcore-models \
    --disable-bias-linear \
    --tokenizer-type HuggingFaceTokenizer \
    --tokenizer-model /mnt/hw-nas/public/models/zjllm-llama3-tokenizer \
