...
#                                              os.path.pardir)))
# sys.path.append("/mnt/seed-program-nas/001688/xiechunhong/1B_Loss_Align/Megatron-LM")
import musa_patch
...
if __name__ == "__main__":
    ...
    results: List[InferenceRequest] = inference_engine.generate(
            prompts=['Once upon a time in a distant galaxy,', 'The feature of machine learning depends on', "Answer the following multiple choice question. The last line of your response should be of the following format: 'ANSWER: $LETTER' (without quotes) where LETTER is one of ABCD. Think step by step before answering.\n\nWhich State ordinarily exercises jurisdiction in respect of crimes committed on board vessels?\n\nA) The coastal State\nB) The flag State\nC) All States enjoy such jurisdiction\nD) The International Tribunal for the Law of the Sea\n"], sampling_params=sampling_params,
        )
