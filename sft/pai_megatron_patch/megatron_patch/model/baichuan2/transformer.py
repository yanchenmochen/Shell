...
from megatron.core.tensor_parallel import gather_from_sequence_parallel_region_to_moe, \
...
class ParallelTransformerLayer(MegatronModule):
    ...
    def __init__(self, config,
        ...
        if args.use_alibi_mask:
            self.alibi = self._build_alibi_tensor(args.seq_length, args.num_attention_heads, args.micro_batch_size).to(
