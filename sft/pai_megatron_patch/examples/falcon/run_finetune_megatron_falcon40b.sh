...
FT_NAME="${ENV}-finetune-megatron-falcon-${MODEL_SIZE}-lr-${LR}-ep-${EPOCH}-bs-${BATCH_SIZE}-seqlen-${SEQ_LEN}-pr-${PR}--do-${DO}-tp-${TP}-ac-${AC}-sp-${SP}"
...
run_cmd="torchrun $DISTRIBUTED_ARGS finetune_megatron_falcon40b.py
