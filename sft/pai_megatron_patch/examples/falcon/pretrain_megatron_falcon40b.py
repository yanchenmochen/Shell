...
from megatron_patch.data.pretrain_dataset import \
    build_pretrain_falcon_datasets_from_original, build_pretrain_falcon_datasets_from_idxmap
...
def train_valid_test_datasets_provider(train_val_test_num_samples):
    ...
    if os.path.isfile(args.data_path[0]):
        train_ds, valid_ds, test_ds = \
            build_pretrain_falcon_datasets_from_original(
                data_prefix=args.data_path,
                max_padding_length=args.max_padding_length)
    else:
        train_ds, valid_ds, test_ds = \
            build_pretrain_falcon_datasets_from_idxmap(
                data_prefix=args.data_path,
                max_padding_length=args.max_padding_length,
