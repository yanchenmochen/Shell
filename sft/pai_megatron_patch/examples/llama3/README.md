...
> Pai-Megatron-Patch
> 目前已支持[LLaMA3.1](https://github.com/alibaba/Pai-Megatron-Patch/blob/main/examples/llama3_1/README.md),
...
请将开源Huggingface模型文件夹路径下的.json (pytorch_model.bin.index.json除外)
文件拷贝至/mnt/llama3-ckpts/Meta-Llama-3-8B-hf-megatron-to-hf目录下，以保证模型可以正常使用。
