#!/bin/bash
#sh run_evaluate_mcore_qwen.sh dsw ../.. 0.5B 1 2048 2048 293 bf16 1 1 sel true false false false /mnt/qwen-datasets/alpaca_zh-qwen-valid.json /mnt/qwen-ckpts/qwen1.5_0.5b_mcore_tp1_pp1_v1
set -e
ENV=$1
