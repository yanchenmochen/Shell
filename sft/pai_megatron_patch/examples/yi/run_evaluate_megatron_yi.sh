#!/bin/bash
#sh run_evaluate_megatron_yi.sh dsw /workspace/Pai-Megatron-Patch 6B 1 80 80 0 bf16 1 1 sel true false true false /mnt/llama2-datasets/alpaca_data.json /mnt/yi-ckpts/Yi-6B-to-mg-tp1-pp1
set -e
ENV=$1
