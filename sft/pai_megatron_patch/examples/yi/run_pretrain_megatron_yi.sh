#!/bin/bash
#sh run_pretrain_megatron_yi.sh dsw /workspace/Pai-Megatron-Patch 6B 2 16 1e-5 1e-6 2048 2048 0 bf16 1 1 sel true false true false 100000  /mnt/llama2-datasets/alpaca_data.json /mnt/yi-ckpts/Yi-6B-to-mg-tp1-pp1 10000000000 100000000 /mnt/output_patch_test
set -e
ENV=$1
