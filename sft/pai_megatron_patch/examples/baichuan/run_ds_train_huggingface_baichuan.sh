#!/bin/bash
# bash run_ds_train_huggingface_baichuan.sh dsw 7B 1 2 1e-5 2048 fp16 2 true /mnt/llama2-datasets/wudao_train.json /mnt/llama2-datasets/wudao_valid.json /mnt/llama2-ckpts/baichuan-7B-hf 2 /mnt/output_baichuan
...
run_cmd="torchrun $DISTRIBUTED_ARGS ds_train_huggingface_baichuan.py ${hf_options} ${pr_options} ${gc_options}"
