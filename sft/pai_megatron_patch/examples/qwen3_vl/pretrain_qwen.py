...
def model_provider(
    ...
    vision_projector_config = get_vision_projection_config(deepcopy(config), vision_config.hidden_size,
...
def get_batch(model, data_iterator):
    ...
    attention_mask, loss_mask, position_ids = get_ltor_masks_and_position_ids(
        model, tokens, image_thw_grids, video_thw_grids, labels, tokenizer.pad_token_id
    )
    torch.cuda.nvtx.range_pop()
