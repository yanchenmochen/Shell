...
export PYTHONPATH=${MEGATRON_PATCH_PATH}:${MEGATRON_PATCH_PATH}/backends/megatron/Megatron-LM-250908:${VERL_ROOT_PATH}:$PYTHONPATH
...
if [ $NODE_RANK -eq 0 ]; then
  ...
  python ../qwen3/verl_entrypoint.py --config-path=../qwen3/verl_configs \
    ...
    actor_rollout_ref.ref.log_prob_micro_batch_size_per_gpu=512 \
