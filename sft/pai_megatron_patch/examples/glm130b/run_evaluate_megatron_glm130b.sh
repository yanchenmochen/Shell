#!/bin/bash
# sh run_evaluate_megatron_glm130b.sh dsw /workspace/Megatron-LM/ /workspace/PAI-Megatron-Patch/ 2B 1 256 128 fp16 1 1 /mnt/wikitext-103/wiki.test.tokens none
set -e
ENV=$1
MEGATRON_PATH=$2
