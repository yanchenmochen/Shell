#!/bin/bash
#sh run_finetune_megatron_qwen_vl.sh dsw /workspace/Alibaba-internal/PAI-Megatron-Patch 7B 1 1e-3 1e-4 2048 2048 0 bf16 1 1 sel true false true false  /mnt/qwen-datasets/qwenvl_train.json /mnt/qwen-datasets/qwenvl_train.json /mnt/qwen-ckpts/Qwen-VL-Chat-small 1 /mnt/output_patch_test
set -e
ENV=$1
...
megatron_options="  \
        ...
        --patch-tokenizer-type QwenVLTokenizer \
        --dataset Qwen-VL-SFT \
        --swiglu \
...
run_cmd="torchrun $DISTRIBUTED_ARGS finetune_megatron_qwen_vl.py
