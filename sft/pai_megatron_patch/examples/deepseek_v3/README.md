...
注意如果使用Cpu
Offloading请务必执行如下链接的修复，否则会出现不收敛：[链接](https://github.com/alibaba/Pai-Megatron-Patch/tree/main/megatron_patch/fixes/optimizer_offloading)

此外，在当前使用的Megatron-Core，Yarn参数设置与Huggingface模型不一致，可参考[链接](https://github.com/alibaba/Pai-Megatron-Patch/tree/main/megatron_patch/fixes/yarn_args)
修复。
