...
def convert_checkpoint_from_transformers_to_megatron(args):
    ...
    for layer_id in range(config.num_hidden_layers):
        ...
        merged_qkv_state_dict['transformer.layers.' + str(layer_id) + '.self_attn.query_key_value.weight'] = torch.cat(
        ...
        merged_qkv_state_dict['transformer.layers.' + str(layer_id) + '.self_attn.query_key_value.bias'] = torch.cat(
