    ...
    for pp_rank in range(args.target_pipeline_model_parallel_size):
        ...
        for layer in range(num_layers):
            ...
            for layer_name in layers_to_copy:
                ...
                elif op_name.startswith("attention.query_key_value") and weight_or_bias == "weight":
                ...
                elif op_name.startswith("attention.query_key_value") and weight_or_bias == "bias":
                    """
                    params = transformers_to_megatron_fix_query_key_value_ordering(
                        params,
                        2.0,
                ...
                if op_name + "." + weight_or_bias in tensor_parallel_params:
                    dim = 1 if op_name in ["attention.dense", "mlp.dense_4h_to_h"] else 0
