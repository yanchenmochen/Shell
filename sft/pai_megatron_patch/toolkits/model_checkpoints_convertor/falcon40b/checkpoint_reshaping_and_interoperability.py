...
megatron_to_transformers_opmap = {
    ...
    "mlp.dense_h_to_4h": "mlp.dense_h_to_4h",
    "mlp.dense_4h_to_h": "mlp.dense_4h_to_h",
    "self_attention.query_key_value": "self_attention.query_key_value",
}
...
def get_megatron_sharded_states(args, tp_size, pp_size, pp_rank):
    ...
    for i in range(tp_size):
        ...
        checkpoint_name = [i for i in os.listdir(os.path.join(args.load_path, sub_dir_name)) if 'rng' in i][0]
...
def convert_checkpoint_from_transformers_to_megatron(args):
    ...
    for layer_id in range(config.num_hidden_layers):
        ...
        internal_state_dict['transformer.layers.' + str(layer_id) + '.self_attn.query_key_value.weight'] = \
            state_dict['transformer.h.' + str(layer_id) + '.self_attention.query_key_value.weight']
