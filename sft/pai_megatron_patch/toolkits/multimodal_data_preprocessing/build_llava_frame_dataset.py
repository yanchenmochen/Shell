...
if __name__ == '__main__':
    ...
    argparser.add_argument("--time-interval", type=float, default=1.0,
                           help="The time interval to extract frame from videos")
    argparser.add_argument("--output-json", type=str, default='dataset.json',
                           help="Filename of the merged json dataset")
    argparser.add_argument("--skip-extraction", action='store_true')
    argparser.add_argument("--video-token", type=str, default='<image>',
