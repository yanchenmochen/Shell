...
DATASET_FILE=/mnt/hw-nas-dataset-12.8/public/data/021-12.8t.datalist
DATA_PATH="$(grep -v '^#' ${DATASET_FILE})"
DATA_CACHE_PATH=/mnt/hw-nas-dataset-12.8/public/datacache/data_128t_1016
...
export PYTHONPATH=/mnt/dataset-12.8t/public/train_32B/Kuae2.1-1022/megatron-lm-musa-patch:/mnt/dataset-12.8t/public//train_32B/Kuae2.1-1022/Megatron-LM:$PYTHONPATH
