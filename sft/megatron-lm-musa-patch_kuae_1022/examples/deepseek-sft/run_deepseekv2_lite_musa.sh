...
set -u
  WORK_HOME="$PWD"
  PATCH_HOME="$PWD"/../..
  PATCH_HOME=/mnt/seed-program-nas/001688/chenyiming/megatron-lm-musa-patch
  ...
  DATA_PATH=/mnt/seed17/001688/haoran.huang/sft/sft_data_preprocessing/mmap_tulu_sft_datasets_text_document_text_document
  HOSTFILE=./hostfile
