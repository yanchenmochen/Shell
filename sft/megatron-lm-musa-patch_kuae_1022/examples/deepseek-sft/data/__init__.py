...
def build_evaluation_dataset(dataset):
    raise NotImplementedError(
        f"Dataset {dataset} is no longer supported in Pai-Megatron-Patch anymore, downgrade to v0.10.2 or lower to use it.")
...
def build_dataset(args, train_val_test_num_samples):
    ...
    if args.dataset == 'JSON-SFT':
        ...
        raise NotImplementedError(
            f"Dataset {args.dataset} is no longer supported in Pai-Megatron-Patch anymore, downgrade to v0.10.2 or lower to use it.")
