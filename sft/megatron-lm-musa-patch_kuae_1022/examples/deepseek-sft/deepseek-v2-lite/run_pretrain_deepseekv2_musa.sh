...
# DATASET_FILE=/mnt/seed-program-nas/001688/huanghuang/data_split/datalist
# DATA_PATH="$(grep -v '^#' ${DATASET_FILE})"
# DATA_CACHE_PATH=/mnt/seed-program-nas/001688/huanghuang/data_split/datacache
DATA_ARGS=(
    --data-path $DATA_PATH
...
EVAL_AND_LOGGING_ARGS=(
    ...
    # --load /mnt/seed-program-nas/001688/haoran.huang/megatron-lm-musa-patch/examples/deepseek-sft/checkpoints
    # --load /mnt/seed-program-nas/001688/chenyiming/1B_Loss_Align_New_Megatron/output/baseline-fp32-gbs4k/checkpoints
    --load /mnt/si0003568lza/default/huanghuang/ckpt_bkup_001688/1B_Loss_Align_New_Megatron/output/std-norm-fp32-gbs4k/checkpoints/
    --no-load-optim
    --eval-iters 0
    --ckpt-format torch
