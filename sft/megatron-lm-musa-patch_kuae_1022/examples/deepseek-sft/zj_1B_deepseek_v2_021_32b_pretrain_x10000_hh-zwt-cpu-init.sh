...
DATASET_FILE=/dataset/dataset/datalist
DATA_PATH="$(grep -v '^#' ${DATASET_FILE})"
DATA_CACHE_PATH=${DATA_CACHE_PATH:-/dataset/dataset/datacache-1t}
TOKENIZED_MODEL=/dataset/Meta-Llama-3-tokenizer
MODEL_NAME=${MODEL_NAME:-'MOE-1B-HH'}
...
OUTPUT_DIR_ORI=${OUTPUT_DIR:-"./output"}
OUTPUT_DIR=${OUTPUT_DIR_ORI}/$JOB_NAME_ZWT

export GLOO_SOCKET_IFNAME=bond0
# export PYTORCH_MUSA_ALLOC_CONF=expandable_segments:True  #hh1027
...
export MUSA_EXECUTION_TIMEOUT=600000
export MUSA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7"
export CUDA_DEVICE_MAX_CONNECTIONS=1
export MUSA_KERNEL_TIMEOUT=600000
...
TENSORBOARD_PATH="${OUTPUT_DIR_ORI}/tf_logs/${JOB_NAME_ZWT}/${CURRENT_TIME}_${MODEL_NAME}_${EXPNAME}"
mkdir -p ${TENSORBOARD_PATH}
# TENSORBOARD_PATH=${TENSORBOARD_PATH:-${TENSORBOARD_PATH_TMP}}
...
DISTRIBUTED_ARGS=(
    ...
    --log_dir $OUTPUT_DIR/output_log/${CURRENT_TIME}/${EXPNAME}/${NODE_RANK}
    --redirects 3
)
...
#cd /mnt/seed-program-nas/001688/chenyiming/Megatron-LM
...
export PYTHONPATH=/mnt/seed-program-nas/001688/chenyiming/megatron-lm-musa-patch:/mnt/seed-program-nas/001688/chenyiming/Megatron-LM:$PYTHONPATH
