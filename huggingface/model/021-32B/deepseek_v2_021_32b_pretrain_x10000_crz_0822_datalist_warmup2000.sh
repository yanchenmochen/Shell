...
DATASET_FILE=/mnt/dataset-12.8t/public/data/021-12.8t.datalist
DATA_PATH="$(grep -v '^#' ${DATASET_FILE})"
DATA_CACHE_PATH=/mnt/dataset-12.8t/public/cairunze/datacache/deepseekv2_datasets/tp_${TP}_pp${PP}_ep${EP}_mbs${MICRO_BATCH_SIZE}_gbs${GLOBAL_BATCH_SIZE}
# DATA_CACHE_PATH="/mnt/x10000/002266/loss_sync/zjlab-megatron.git/zj_examples/deepseek_v2/500B_data_cache"
TOKENIZED_MODEL=/mnt/x10000/002266/models/zjllm-llama3-tokenizer
...
torchrun ${DISTRIBUTED_ARGS[@]} run_text_generation_server.py \
        ${MODEL_ARGS[@]} \
        ${TRAINING_ARGS[@]} \
        ${REGULARIZATION_ARGS[@]} \
        ${LEARNING_RATE_ARGS[@]} \
