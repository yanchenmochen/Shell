...
MEGATRON_HOME=/mnt/moer-train/public/train_32B/Kuae2.1-1022
export PYTHONPATH=$MEGATRON_HOME/megatron-lm-musa-patch:$MEGATRON_HOME/Megatron-LM:$PYTHONPATH
...
pretrain_file=$MEGATRON_HOME/megatron-lm-musa-patch/examples/deepseek-v2/pretrain_deepseekv2.py

xpu_timer_launch torchrun ${DISTRIBUTED_ARGS[@]} $pretrain_file \
        ${MODEL_ARGS[@]} \
        ${TRAINING_ARGS[@]} \
        ${REGULARIZATION_ARGS[@]} \
        ${LEARNING_RATE_ARGS[@]} \
